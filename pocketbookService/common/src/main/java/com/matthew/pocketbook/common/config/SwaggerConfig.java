...
//                .groupName("分布式任务系统") // 如果配置多个文档的时候，那么需要配置groupName来分组标识
            ...
            .apis(RequestHandlerSelectors.basePackage("com.matthew.pocketbook.business")) // 用于指定扫描哪个包下的接口
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            .title("记账本项目API") //  可以用来自定义API的主标题
            .description("记账本项目SwaggerAPI管理") // 可以用来描述整体的API
